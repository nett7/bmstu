...
- [ ] 7. Схемы замещения реальных пассивных элементов.
- [ ] 8. Электрическая схема цепи и законы равновесия электрических сил (законы Кирхгофа).
- [ ] 9. Схемы замещения реальных активных элементов (на примере аккумулятора).
