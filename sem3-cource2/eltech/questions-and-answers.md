...
цепи, является электрическое сопротивление или просто со- противление. Оно равно отношению величины напряжения на участке цепи
к току в нём `R=u/i`.
...
и численно равная `Wм = L⋅i2 /2`. Коэффициент L, определяющий энергию магнитного поля называется индуктивностью.
