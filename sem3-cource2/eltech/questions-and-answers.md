...
- [x] 14. *Расчет простых цепей методом эквивалентных преобразований.*
- [x] 15. *Расчет сложных цепей методом эквивалентного генератора.*
- [x] 16. *Расчет цепей методом узловых потенциалов.*
- [x] 17. *Расчет цепей методом контурных токов.*
- [x] 18. Мощности в цепи синусоидального тока: активная, реактивная, полная. Мощности в комплексной форме записи.
...
- [ ] 28. Расчет установившихся режимов в цепи периодического несинусоидального тока: определение мгновенных и действующих значений тока(напряжения).

### трехфазные цепи

- [x] 29. Схема соединения трехфазного генератора и нагрузки "звездой" и "треугольником". Достоинство цепей и особенности расчета.
...
```
### 19. 
Показания измерительных приборов (амперметр, вольтметр, ваттметр) в цепи синусоидального тока.
### 20. 
- Явление взаимо индукции и уравнения для индуктивно связанных элементов.
...
k = M / sqrt(L1*L2)
L1 = ψ11/i1 = w1Ф11/i1
M21 =  ψ21/i1 = w2Ф21/i1; Ф21 - магнитный поток самоиндукции
```
### 21. Замена "магнитных" связей электрическими ("магнитная развязка")
### 22. Особенности расчета цепей со взаимоиндукцией в установившемся гармоническом режиме.
[пример решения](https://www.toehelp.ru/theory/toe/lecture10/lecture10.html)

### 28.
- Расчет установившихся режимов в цепи периодического несинусоидального тока: 
...
```
u(t) = U0 + summ(k=1 to inf) (Bksinkwt + Ckcoskwt)
...
Ck = 2/T ∫(from 0 to T) u(t)sin kwt dt
Bk = 2/T ∫(from 0 to T) u(t)cos kwt dt
Ukm = sqrt(Bk^2 + Ck^2)
ψk = arctg (Ck/Bk)
u(t) = U0 + summ(k=1 to inf) (Ukm sin(k(2pi/T*t + ψk)))
```
- определение мгновенных и действующих значений тока(напряжения).
### 29. 

Под трехфазной системой ЭДС понимают совокупность трех синусоидальных ЭДС, созданных, как правило, одним источником энергии(генератором), имеющих одинаковую частоту и амплитуду и сдвинутых по фазе друг относительно друга на 120 градусов.
